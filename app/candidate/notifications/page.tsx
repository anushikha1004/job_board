...
import { Bell, Briefcase, CircleCheck, MailCheck, Settings, UserRound } from 'lucide-react';
...
export default function CandidateNotificationsPage() {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        if (role === 'company') {
          router.replace('/company/notifications');
          return;
        }
        ...
        console.error('Candidate notifications load error:', err);
  ...
  const notifications = useMemo(() => buildCandidateNotifications(applications), [applications]);
            ...
            <section className="glass rounded-2xl p-7 md:p-8">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <div>
                  ...
                  <p className="mt-2 text-foreground-muted">Latest updates about your applications.</p>
                </div>
                <button
                  type="button"
